...
function highlight(i){
    ...
    for(let j=0; j<rindas_copy.length;j++){
        if (j ===i){
            rindas_copy[j]="<span style=\"color:white\">"+rindas_copy[j]+"</span>";
        }
        else{
    ...
    rindas_copy[i]="<span style=\"color:white\">"+rindas_copy[i]+"</span>"
